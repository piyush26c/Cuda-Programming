...
//https://github.com/piyush26c/Cuda-Programming/blob/main/Assignment_6_Vector%20addition_Matrix%20multiplication_.cu
//Code Title : Add two vectors parallel and perform n * n matrix multiplication parallelly.
...
#define VECTOR_SIZE_ 3 //means 8 * 8 matrix
...
int main(void) {
    ...
    {//matrix multiplication scope starts
        ...
        printf("\nMatrix Size : %d * %d", VECTOR_SIZE, VECTOR_SIZE);
        printf("\nMATRIX VECTOR A : ");
